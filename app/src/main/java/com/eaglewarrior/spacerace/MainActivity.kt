package com.eaglewarrior.spacerace
...
import com.eaglewarrior.spacerace.spacecrafts.Advantis
import com.eaglewarrior.spacerace.spacecrafts.Rapidus
import com.eaglewarrior.spacerace.spacecrafts.Spacecraft
import com.eaglewarrior.spacerace.spacecrafts.Ultimus
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Task 4 - add SpaceCraft to the ArrayList
        availableSpacecrafts.add(Spacecraft(universe = this))
        // Task 5 - add Advantis to the ArrayList
        availableSpacecrafts.add(Advantis(universe = this))
        // Task 6 - add Rapidus to the ArrayList
        availableSpacecrafts.add(Rapidus(this))
        // Task 7 - add Ultimus to the ArrayList
        availableSpacecrafts.add(Ultimus(this))
    ...
    fun switchSpacecraft(newIndex: Int) {
        ...
        // Task 4 - access the spacecraft's image ID
    ...
    fun btnLaunchTapped(view: View) {
        ...
        activeSpacecraft?.let {
            ...
            // Task 4 - call the spacecraft's launch() method
            it.launch()
